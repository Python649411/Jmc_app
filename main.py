...
class 점메추App(App):
    ...
    def build(self):
        ...
        self.ko = ['김치찌개','된장찌개','순두부찌개','부대찌개','갈비탕','설렁탕','순대국밥','콩나물국밥','뼈해장국','미역국','감자탕','비빔밥','김치볶음밥','돌솥비빔밥','제육덮밥','오징어덮밥','뚝배기제육','잔치국수','김치말이국수','칼국수','쌀국수','평양냉면','물냉면','비빔냉면','삼겹살','돼지갈비','소불고기','제육볶음','닭볶음탕','족발','장충동보쌈','떡볶이','어묵','찜닭','아구찜','간장게장','보리밥','쭈구미볶음']
        ...
        self.menu_label = Label(text='오늘 점심을 뭐 먹을지 고민된다면? 점메추 버튼 한번으로 점심먹기!', font_name='BMJUA_ttf.ttf', font_size=30)
        button = Button(text='랜덤 점메추하기',font_name='BMJUA_ttf.ttf',size_hint_y=None, height=100 , font_size=50)
        ...
        button.bind(on_press=self.all1)
